	...
	<div class="layui-container">
		<table class="layui-table" id="tbdata" lay-filter="tbop">
			...
			<tbody>
				...
				<c:forEach items="${pageBean.list }" var="depart">
					<tr>
						<td>${depart.id }</td>
						<td>${depart.name }</td>
						<td>${depart.count }</td>
						<td>${depart.createtime }</td>
						<td><a class="layui-btn layui-btn-mini" href="${pageContext.request.contextPath}/depart/update/${depart.id}">编辑</a>
							<a class="layui-btn layui-btn-danger layui-btn-mini"
							lay-event="del" href="${pageContext.request.contextPath}/depart/delete/${depart.id}">删除</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
