		...
		<table class="layui-table" id="tbdata" lay-filter="tbop">
			...
			<c:forEach items="${pageBean.list}" var="g">
				<tr>
					...
					<td>${g.location}</td>
					<td>${g.createdate}</td>
					<td><a class="layui-btn layui-btn-mini" href="${pageContext.request.contextPath}/grade/update/${g.id}">编辑</a>
						<a class="layui-btn layui-btn-danger layui-btn-mini"
						lay-event="del" href="${pageContext.request.contextPath}/grade/delete/${g.id}"">删除</a></td>
				</tr>
			</c:forEach>
			</tbody>
		</table>
