...
<body>
	<div class="layui-container" style="margin-top: 5px">
		<form class="layui-form" action="${pageContext.request.contextPath}/student/updateInfo/${student.id}" method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="no" lay-verify="required"
						placeholder="请输入学号" autocomplete="off" class="layui-input" value="${student.email }">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<select name="education">
					<c:if test="${student.education=='初中' }">
					...
					<c:if test="${student.education=='高中' }">
						<option>初中</option>
					...
					<c:if test="${student.education=='专科' }">
						<option>初中</option>
						<option>高中</option>
					...
					<c:if test="${student.education=='本科' }">
						<option>初中</option>
						<option>高中</option>
						<option>专科</option>
					...
					<c:if test="${student.education=='硕士' }">
						<option>初中</option>
						<option>高中</option>
						<option>专科</option>
						<option>本科</option>
					...
					<c:if test="${student.education=='博士' }">
						<option>初中</option>
						<option>高中</option>
						<option>专科</option>
						<option>本科</option>
