...
<body>
	...
	<div class="layui-container" style="margin-top: 5px">
		<form class="layui-form" action="${pageContext.request.contextPath}/course/addCourse" method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" id="f7" lay-verify="name" autocomplete="off"
						placeholder="请输入班级人数"  class="layui-input" name="count" value="${course.count}">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">成立日期</label>
				<div class="layui-input-block">
				 <input type="text" name="createdate" id="date" autocomplete="off" class="layui-input" placeholder="请输入成立日期">
				</div>
			</div>
			<div class="layui-form-item">
